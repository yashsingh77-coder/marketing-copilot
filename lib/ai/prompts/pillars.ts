export const pillarsPrompt = `Generate 4-6 content pillars for this business.

Rules:
- Each pillar must be something the owner can shoot on a phone in under 10 minutes.
- At least one pillar must be hyper-local (area/city/festivals/neighbours).
